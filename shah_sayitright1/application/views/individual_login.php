...
//    $stmt = $conn->prepare($sql);
//     $stmt->execute(["0", $_POST["fname"], $_POST["lname"], $_POST["email"], $_POST["school"], $_POST['work'], '1']);
//    
...
<body>
  <div id="wrapper">
      ...
      <hr width="90%" style="color: grey;">
        <br>
      <center style="font-family: sans-serif;">Welcome to the individual sign up</center>
          
<!--      <form style="padding-left: 5px;" method="post" action="<?php 
...
?>">-->
				...
				<?php echo form_open('Ct_addUserIndiv');?>
