...
<body>
	<div id="wrapper">
        ...
        echo "</tr>";
            ...
            <input type="button" value="New" <?php if (!($rid == '3')){ ?> disabled <?php   } ?> onclick="location = 'newBus.php'" />
<input type="button" value="Update" <?php if (!($rid == '3')){ ?> disabled <?php   } ?> onclick="location = 'updateBus.php'" />
                    <input type="button" value="Delete" <?php if (!($rid == '3')){ ?> disabled <?php   } ?> onclick="location = 'deleteBus.php'" />
