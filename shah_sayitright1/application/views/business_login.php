...
//    }
//  
//    if($fnameErr == "" && $lnameErr=="" && $emailErr=="" && $schoolErr=="" && $workErr=="" && $passErr=="" && $userErr==""){
//     $sql =  "INSERT INTO `users`(`u_id`, `f_name`, `l_name`, `email`, `school_name`, `place_work`, `r_id`) VALUES (?,?,?,?,?,?,?)";
//    $stmt = $conn->prepare($sql);
//     $stmt->execute(["0", $_POST["fname"], $_POST["lname"], $_POST["email"], $_POST["school"], $_POST['work'], '3']);
//    
...
<body>
  <div id="wrapper">
      ...
      <br>
      <center style="font-family: sans-serif;">Welcome to the business sign up </center>
<!--
...
-->             <?php 
				...
				<?php echo form_open('Ct_addUserBus');?>

          
        <p>
              type of business: <input type="radio" id="businessChoice1"
     name="business1" value="university">
    <label for="businessChoice1">University</label>

    <input type="radio" id="businessChoice2"
     name="business2" value="company">
    <label for="businessChoice2">Company</label>
        </p> 
            <input type="text" name="fname" placeholder="Enter your name" size="50" style="margin-bottom: 10px;"><!--           required        -->
            <br>
            
            <input type="text" name="lname" placeholder="Enter your last name" size="50" style="margin-bottom: 10px;"><!--           required        -->
            <br>
            <input type="text" name="work" placeholder="Enter place work" size="50" style="margin-bottom: 10px;"><!--           required        -->
            <br>
            
            <input type="text" name="school" placeholder="Enter school" size="50" style="margin-bottom: 10px;"><!--           required        -->
            <br>
